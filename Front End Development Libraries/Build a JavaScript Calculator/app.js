	...
	render() {
		return (
			<div id="Container">
				...
				<div id="Calc">
					{DATA.map(data => (
						<button id={data.id} onClick={this.handleNumbers} value={data.value}>
							{data.value}
						</button>
					))}
					<button id="clear" onClick={this.initialize} value="AC">
						AC
					</button>
					<button id="divide" onClick={this.handleOperators} value="/">
						/
					</button>
					<button id="multiply" onClick={this.handleOperators} value="x">
						x
					</button>

					<button id="subtract" onClick={this.handleOperators} value="‑">
						‑
					</button>

					<button id="add" onClick={this.handleOperators} value="+">
						+
					</button>
					<button id="decimal" onClick={this.handleDecimal} value=".">
						.
					</button>
					<button id="equals" onClick={this.handleEvaluate} value="=">
						=
					</button>
				</div>
			</div>
